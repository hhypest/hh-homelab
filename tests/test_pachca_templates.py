...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Замечание Codex: оценка по короткой стороне без поворота завышала
        # вертикальное видео на ступень — 720×1280 называлось 1080p.
        ("720", "1280", "720p", "вертикальное видео"),
        ("1080", "1920", "1080p", "вертикальное 1080p"),
        ("2160", "3840", "2160p (4K)", "вертикальный 4K"),
