...
Home Assistant, дашборд, шаблоны уведомлений и два подробных чек-листа.
...
Пять документов, каждый отвечает на свой вопрос.
...
| **[Уведомления в Пачку](pachca/README.md)** | Какой бот в каком чате, где чей шаблон, как настроить каждый сервис | справочник |
| **[Роутер](docs/keenetic.md)** | Что в настройках Keenetic влияет на этот стек и чего лучше не трогать | заметки |
| **[Дорожная карта](docs/roadmap.md)** | Куда это может расти дальше, в каком порядке и чего решено не делать | план |

Чек-листы — интерактивные страницы: отметки сохраняются в браузере, прогресс
виден в боковой панели. Ссылки заработают после включения GitHub Pages:
...
[Дорожная карта](docs/roadmap.md) пригодится, когда всё заработает
...
| Уведомления перестали приходить | [pachca/README.md](pachca/README.md), раздел «Два правила» |
...
│   └── roadmap.md                   дорожная карта и точки роста
├── scripts/
...
Что с этим железом планируется делать дальше — в [дорожной карте](docs/roadmap.md):
память до 12 ГБ, том на NVMe, Zigbee-координатор в USB.
