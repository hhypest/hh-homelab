...
В «Кинозале» говорят четыре бота медиа-стека — Radarr, Prowlarr, Jellyfin
и Seerr, у каждого свой Liquid-шаблон. В «Мониторинге» — один бот
Home Assistant, и шаблона у него нет: он шлёт готовый текст. Так вышло
не из вкуса, а из устройства Пачки: шаблон задаётся на боте и применяется
ко всем его сообщениям, поэтому одним ботом четыре разных payload не
обслужить. Подробности — в [`pachca/README.md`](pachca/README.md).
